  ...
  void activateRewardServo(char mode){
    switch(mode){
      case 'A':
        Serial.println("Metal Servo Activated");
        bread_servo.write(180);
        delay(reward_servo_timer*1000);
        bread_servo.write(90);
        Serial.println("Metal Servo Deactivated");
        break;
      case 'B':
      Serial.println("Plastic Servo Activated");
        tissue_servo.write(180);
        delay(reward_servo_timer*1000);
        tissue_servo.write(90);
        Serial.println("Plastic Servo Deactivated");
        break;
    }
  }